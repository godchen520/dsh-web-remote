...
const INJECT_SCRIPT = `(function () {
  ...
  function attachButton(btn) {
    ...
    if (area) {
      // 容器改为横向 flex，靠右对齐：设置图标保持最右，手机按钮贴其右侧
      try {
