...
const INJECT_SCRIPT = `(function () {
  ...
  function renderStatus(panel, info, hint) {
    ...
    if (h2) {
      ...
      parts.push('提示：点「换新链接」可立即生成全新公网链接（旧链接失效时使用）。');
...
export function apply(ctx, rawConfig) {
  ...
  const start = async () => {
    ...
    try {
      ...
      const tunnelArgs = [cloudflaredPath, 'tunnel', '--url', 'http://127.0.0.1:' + httpPort, '--no-autoupdate'];
